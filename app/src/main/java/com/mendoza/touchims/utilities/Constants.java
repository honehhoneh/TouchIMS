...
public class Constants {
    ...
    //    public static final String CURRENT_TIME = new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date());
    ...
    public static final String URL_ATTENDANCE_CHECK = ROOT_URL + "attendanceCheck.php";
